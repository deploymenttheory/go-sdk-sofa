...
type VisionOSV2FeedResponse struct {
	...
	Devices                        struct {
		// "RealityDevice14,1" cannot be unmarshalled into a struct field by encoding/json.
		// "RealityDevice17,1" cannot be unmarshalled into a struct field by encoding/json.
	} `json:"Devices"`
